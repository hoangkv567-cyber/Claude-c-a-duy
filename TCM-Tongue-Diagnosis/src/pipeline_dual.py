...
class TCMTongueFacePipeline:
    ...
    def run(self, tongue_image_path: str, face_image_path: str) -> dict:
        logger.info(f"Bắt đầu chạy pipeline kết hợp: Lưỡi={tongue_image_path}, Mặt={face_image_path}")
        
        # Chẩn đoán lưỡi
        symptoms_tongue = self.ollama_client.diagnose_image(tongue_image_path, modality="tongue")
        ...
        # Chẩn đoán mặt
        symptoms_face = self.ollama_client.diagnose_image(face_image_path, modality="face")
